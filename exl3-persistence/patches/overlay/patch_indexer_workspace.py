...
# PORT 83252ea89: upstream renamed MLAAttentionSpec.compress_ratio ->
# .tokens_per_state and added an int assert around it; the local
# attribute self.compress_ratio and everything downstream is unchanged,
# so this is an anchor-text update only.
