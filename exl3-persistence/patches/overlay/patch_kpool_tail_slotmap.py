...
# PORT 83252ea89: upstream wrapped this slot-mapping loop in the
# context-parallel branch (TOTAL_CP_WORLD_SIZE / CP_KV_CACHE_INTERLEAVE_SIZE),
# so the snippet now sits one indent level deeper (12 spaces). Text and
# semantics are otherwise unchanged; this is a re-indent only.
